...
Public Class Form1
    ...
    Private Sub GenerateScriptButton_Click(sender As Object, e As EventArgs) Handles GenerateScriptButton.Click
        Try
            ...
            scriptContent = scriptContent.Replace("$GotifyServer = ""YOUR SERVER""", "$GotifyServer = """ & gotifyServer & """").
                                          Replace("$GotifyPort = ""80""", "$GotifyPort = """ & gotifyPort & """").
                                          Replace("title = ""CUSTOMER: EXAMPLE PC""", "title = """ & customerName & """").
                                          Replace("APP TOKEN FOR FAILED AND WARNING", appToken).
                                          Replace("PRIMARY TOKEN", primaryToken).
                                          Replace("$TimeDifference.TotalMinutes -gt 10", "$TimeDifference.TotalMinutes -gt " & timeDifference)
